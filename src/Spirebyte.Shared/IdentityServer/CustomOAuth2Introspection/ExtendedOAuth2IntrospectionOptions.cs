...
namespace Spirebyte.Shared.IdentityServer.CustomOAuth2Introspection
{
    ...
    public class ExtendedOAuth2IntrospectionOptions : AuthenticationSchemeOptions
    {
        ...
        /// </summary>
        public Func<ExtendedOAuth2IntrospectionOptions,string, string> CacheKeyGenerator { get; set; } = CacheUtils.CacheKeyFromToken();

        /// <summary>
        /// Specifies the method how to retrieve the token from the HTTP request
        /// </summary>
        public Func<HttpRequest, string> TokenRetriever { get; set; } = Infrastructure.TokenRetrieval.FromAuthorizationHeader();
