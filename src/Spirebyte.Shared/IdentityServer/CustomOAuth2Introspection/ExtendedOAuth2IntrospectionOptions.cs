...
/// </summary>
public class ExtendedOAuth2IntrospectionOptions : AuthenticationSchemeOptions
{
    ...
    ///     ctor
    /// </summary>
    public ExtendedOAuth2IntrospectionOptions()
    {
        Events = new ExtendedOAuth2IntrospectionEvents();
    }
    ...
    /// </summary>
    public Func<ExtendedOAuth2IntrospectionOptions, string, string> CacheKeyGenerator { get; set; } =
    ...
    public Func<HttpRequest, string> TokenRetriever { get; set; } =
        Infrastructure.TokenRetrieval.FromAuthorizationHeader();
    ...
    /// <summary>
    ///     Gets or sets the <see cref="ExtendedOAuth2IntrospectionEvents" /> used to handle authentication events.
    /// </summary>
    public new ExtendedOAuth2IntrospectionEvents Events
    {
    ...
    public override void Validate()
    {
        ...
        if (TokenRetriever == null) throw new ArgumentException("TokenRetriever must be set", nameof(TokenRetriever));
    }
}